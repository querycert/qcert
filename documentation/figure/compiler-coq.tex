...
% DNNRC
 ...
 \path[trans, tcoqp] (nnrsimp) -- (impqcert)
   \transref{6}{\coqurl{Translation.Lang}{NNRSimptoImpQcert}{nnrs_imp_to_imp_qcert_top}};
 \path[trans, tcoqp] (impqcert) -- (impjson)
   \transref{6}{\coqurl{Translation.Lang}{ImpQcertoImpEJson}{imp_qcert_to_imp_ejson_top}};
