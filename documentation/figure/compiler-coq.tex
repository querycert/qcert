...
% DNNRC
 ...
 \path[trans, tcoqp] (nnrsimp) -- (impqcert)
   \transref{6}{\coqurl{Translation}{NNRSimptoImpQcert}{nnrs_imp_to_imp_qcert_top}};
 \path[trans, tcoqp] (impqcert) -- (impjson)
   \transref{6}{\coqurl{Translation}{ImpQcertoImpEJson}{imp_qcert_to_imp_ejson_top}};
 \path[trans, tcoqc] (impjson) -- (ajs)
   \transref{6}{\coqurl{Translation}{ImpEJsontoJavaScriptAst}{imp_ejson_to_js_ast_top}};
