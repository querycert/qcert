...
let suffix_of_language lang =
  match lang with
  | Compiler.Coq__23.L_rule -> suffix_rule ()
  | Compiler.Coq__23.L_camp -> suffix_camp ()
  | Compiler.Coq__23.L_oql -> suffix_oql ()
  | Compiler.Coq__23.L_lambda_nra -> suffix_lambda_nra ()
  | Compiler.Coq__23.L_nra -> suffix_nra ()
  | Compiler.Coq__23.L_nraenv -> suffix_nraenv ()
  | Compiler.Coq__23.L_nnrc -> suffix_nnrc ()
  | Compiler.Coq__23.L_dnnrc_dataset -> suffix_dnnrc_dataset ()
  | Compiler.Coq__23.L_dnnrc_typed_dataset -> suffix_dnnrc_typed_dataset ()
  | Compiler.Coq__23.L_nnrcmr -> suffix_nnrcmr ()
  | Compiler.Coq__23.L_cldmr -> suffix_nnrcmr_cldmr ()
  | Compiler.Coq__23.L_javascript -> suffix_javascript ()
  | Compiler.Coq__23.L_java -> suffix_java ()
  | Compiler.Coq__23.L_spark -> suffix_spark ()
  | Compiler.Coq__23.L_spark2 -> suffix_spark2 ()
  | Compiler.Coq__23.L_cloudant -> suffix_cld_design ()
  | Compiler.Coq__23.L_error _ -> suffix_error ()
