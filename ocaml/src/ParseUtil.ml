...
let parse_nnrc_impish_sexp f : QLang.nnrc_impish = AstsToSExp.sexp_to_nnrc_impish (parse_sexp f)
let parse_nnrc_imp_sexp f : QLang.nnrc_imp = AstsToSExp.sexp_to_nnrc_imp (parse_sexp f)
...
let parse_query l f : (string * QLang.query) =
  ...
  | QcertCompiler.L_nnrc_impish_core -> ("NNRCimpishCore", QcertCompiler.Q_nnrc_impish_core (parse_nnrc_impish_sexp f)) (* XXX TODO: check is core XXX *)
  | QcertCompiler.L_nnrc_impish -> ("NNRCimpish", QcertCompiler.Q_nnrc_impish (parse_nnrc_impish_sexp f))
  | QcertCompiler.L_nnrc_imp -> ("NNRCimp", QcertCompiler.Q_nnrc_imp (parse_nnrc_imp_sexp f))
