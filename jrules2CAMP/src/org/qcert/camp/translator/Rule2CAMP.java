...
public class Rule2CAMP {
	 ...
	 * <ul>
	 * <li><b>-output</b> <em>directory</em> (optional) specifies where <b>.camp</b> and/or <b>_test.json</b> files should be placed.  
	 * Otherwise, they go in the same directory for rules specified as files and in the current directory for rules specified as designer 
	 * links.
	 * 
	...
	public static void main(String[] args) throws Exception {
		...
		for (String arg : ordinaryArguments)
			process(arg, outputDir, workspace, schema, input);
	}
	 ...
	 * @throws Exception
	 */
	private static void process(String arg, String outputDir, String workspace, JsonElement schema, JsonObject input) throws Exception {
