\begin{tikzpicture}[
 ...
 \node[lang, coqc, hyperlink node=\coqurl{CldMR.Lang}{CldMR}{cldmr},
       right=3em of nnrcmr]
      (cldmr) {CldMR};
 \node[lang, coqp, hyperlink node=\coqurl{NNRCimpish.Lang}{NNRCimpish}{nnrc_impish},
       above=3em of nnrcmr]
      (nnrcimpish) {NNRCimpish};
...
% DNNRC
 ...
 \path[trans, tcoqp] (nnrc) -- (nnrcimpish)
   \transref{3}{\coqurl{Translation}{NNRCtoNNRCimpish}{nnrc_to_nnrc_impish_top}};
 ...
 % *NNRCimpish
 \path[trans, tcoqc] (nnrcimpish) -- (ajs)
   \transref{6}{\coqurl{Translation}{NNRCimpishtoJavaScriptAst}{nnrc_impish_to_js_ast_top}};
