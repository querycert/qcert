...
let args_list gconf =
  Arg.align
    [ ("-version", Arg.Unit QcertUtil.get_version,
      ...
      ("-log-optims-nra", Arg.String (nra_set_trace logger_nra_to_sexp),
       " Enable optimization logging for nra");
      ("-log-optims-nrc", Arg.String (nrc_set_trace logger_nrc_to_sexp),
       " Enable optimization logging for nrc");
      ("-log-optims-nnrs-imp", Arg.String (nnrs_imp_all_set_trace logger_nnrs_imp_expr_to_sexp logger_nnrs_imp_stmt_to_sexp logger_nnrs_imp_to_sexp),
       " Enable optimization logging for nnrs-imp");
      ("-log-optims-nnrs-imp-expr", Arg.String (nnrs_imp_expr_set_trace logger_nnrs_imp_expr_to_sexp),
       " Enable optimization logging for nnrs-imp-expr");
      ("-log-optims-nnrs-imp-stmt", Arg.String (nnrs_imp_stmt_set_trace logger_nnrs_imp_stmt_to_sexp),
       " Enable optimization logging for nnrs-imp-stmt");
      ("-log-optims-nnrs-imp-top", Arg.String (nnrs_imp_set_trace logger_nnrs_imp_to_sexp),
       " Enable optimization logging for nnrs-imp top level");
      ("-log-optims-dnrc", Arg.String (dnrc_set_trace logger_dnrc_to_sexp),
