...
/**
 * Represents the dright data constructor
 * The dright of unit is common and is represented by a static field in CampData
 */
public class RightData extends CampData {
	private final CampData value;

	public RightData(CampData value) {
		this.value = value;
	}
