...
Module QEval(runtime:CompilerRuntime).
  ...
  Section QE.
    ...
    Definition eval_query {bm:brand_model} : query -> eval_input -> eval_output := @eval_query _ _ _ _ _ _ bm.

    Definition eval_query_debug {bm:brand_model} : query -> eval_input -> eval_output := @eval_query_debug _ _ _ _ _ _ bm.
