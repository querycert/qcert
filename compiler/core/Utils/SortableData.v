...
Section SortByGen.
  ...
  Lemma sort_sortable_coll_sorted {A:Set} (scl:list (A -> option sdata)) (l1: list A)
    (l2: sortable_coll):
  ...
  Lemma sort_sortable_coll_StronglySorted {A:Set} (scl:list (A -> option sdata)) (l1: list A)
    (l2: sortable_coll):
    lift sort_sortable_coll (fsortable_coll_of_coll scl l1) = Some l2 ->
  ...
  Proof.
    ...
    eapply sort_sortable_coll_sorted; apply H.
