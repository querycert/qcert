...
%start <(string * Qcert_coq.Compiler.EnhancedCompiler.QLang.camp_rule)> rulemain
%start <(string * Qcert_coq.Compiler.EnhancedCompiler.QLang.camp)> campmain
%type <Qcert_coq.Compiler.EnhancedCompiler.QLang.camp_rule -> Qcert_coq.Compiler.EnhancedCompiler.QLang.camp_rule> rule_rule
