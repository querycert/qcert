...
public class QUtil {
    ...
    /** JavaScript context from QIO
     * @param QIO the I/O content
     * @return JavaScript string to set input/inheritance
     */
    public static String jsFunFromQIO(QIO qio) {
	JsonObject input = qio.getInput();
	JsonArray inheritance = qio.getInheritance();
     ...
     */
    public static String loadSchema(String schemaFile) throws IOException {
	JsonElement rawInput = new JsonParser().parse(new FileReader(schemaFile));
