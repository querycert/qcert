...
Section TcNRAEnvEq.
  ...
  Proof.
    constructor.
    - unfold Reflexive, tcnraenv_eq; intros.
      reflexivity.
    - unfold Symmetric, tcnraenv_eq; intros.
      rewrite (H x0 c env dt_x dt_c dt_env); reflexivity.
    - unfold Transitive, tcnraenv_eq; intros.
  ...
  Notation "X ≡τₑ Y" := (tcnraenv_eq X Y) (at level 80).               (* ≡ = \equiv *)
  ...
  Proof.
    unfold tcnraenv_eq, cnraenv_eq; intros.
    eapply H; eauto.
  Qed.
  ...
  Proof.
    unfold tcnraenv_rewrites_to, tcnraenv_eq; intros.
  ...
  Proof.
    ...
    - unfold tcnraenv_rewrites_to; intros.
      ...
      reflexivity.
    - unfold tcnraenv_rewrites_to in *; intros.
  ...
  Proof.
    unfold Proper, respectful, tcnraenv_rewrites_to; intros.
...
Notation "X ≡τ Y" := (tcnraenv_eq X Y) (at level 80) : cnraenv_scope.               (* ≡ = \equiv *)
Notation "X ≡τ' Y" := (tcnraenv_eq (exist _ _ X) (exist _ _ Y)) (at level 80) : cnraenv_scope.               (* ≡ = \equiv *)
