...
Section TcNNRCEq.
  ...
  Proof.
    ...
    generalize (@typed_nnrc_yields_typed_data _ _ τ₁ cenv env τenv y0 H3 H4 H); intros.
    elim H6; intros.
    rewrite H5 in H7.
  ...
  Proof.
    intros.
    generalize (@typed_nnrc_yields_typed_data _ _ (Coll τ) cenv env τenv e H H0 H1); intros.
