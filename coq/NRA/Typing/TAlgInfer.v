  ...
  Proof.
    ...
    - Case "AMap"%string.
      ...
      + specialize (IHe2 τin r H0). rewrite H0 in H. simpl in *.
        ...
        rewrite H in H3.
        inversion H3.
        apply (@ATMap m τin r0 r1); try assumption.
    ...
    - Case "AMapConcat"%string.
      ...
      + specialize (IHe2 τin r H0). rewrite H0 in H; simpl in *.
        ...
        * rewrite H0 in H; simpl in H.
          ...
          generalize (@ATMapConcat m τin l1' l2' (rec_concat_sort l1' l2')
    ...
    - Case "AProduct"%string.
      ...
      + specialize (IHe1 τin r H0). rewrite H0 in H; simpl in *.
        ...
        generalize (@ATProduct m τin l1' l2' (rec_concat_sort l1' l2')
                               e1 e2 pf1' pf2' H2 IHe1 IHe2 eq_refl); intros.
        assert (τout = (Coll (Rec Closed (rec_concat_sort l1' l2') H2))).
          assert ((@RecMaybe (@basic_model_foreign_type m)
            (@brand_model_relation (@basic_model_foreign_type m)
    ...
    - Case "ASelect"%string.
      ...
      + specialize (IHe2 τin r H0). rewrite H0 in H. simpl in *.
        ...
        apply (@ATSelect m τin r0); try assumption.
    ...
    - Case "AEither"%string.
      ...
      specialize (IHe1 (exist (fun τ₀ : rtype₀ => wf_rtype₀ τ₀ = true) x1 e0) τout).
      specialize (IHe2 (exist (fun τ₀ : rtype₀ => wf_rtype₀ τ₀ = true) x2 e3) τout).
    ...
    - Case "AEitherConcat"%string.
      ...
      apply (@ATEitherConcat m τin x x4 x1 x3 x0 x2 _ _ e1 e2); try reflexivity.
