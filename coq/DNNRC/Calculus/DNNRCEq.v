...
Section DNNRCEq.
  ...
  Context {T:Type}.
  Context {plug:@AlgPlug fruntime T}.
  ...
  Definition dnnrc_eq (e1 e2:dnrc) : Prop :=
    ...
    forall (denv:dbindings),
      ...
      @dnrc_eval _ A h T plug denv e1 = @dnrc_eval _ A h T plug denv e2.
  ...
  Proof.
    ...
    - unfold Symmetric, dnnrc_eq.
      intros; rewrite (H h denv) by trivial; reflexivity.
    - unfold Transitive, dnnrc_eq.
      intros; rewrite (H h denv) by trivial;
      rewrite (H0 h denv) by trivial; reflexivity.
  Qed.
  ...
  Proof.
    ...
    case_eq (@dnrc_eval _ _ h _ plug denv y1);
      case_eq (@dnrc_eval _ _ h _ plug denv y2); intros; simpl; trivial.
